package com.misispiclix.authserver.configuration;
...
@Configuration // https://docs.spring.io/spring-authorization-server/docs/current/reference/html/getting-started.html
@EnableWebSecurity
public class SecurityConfig {

    @Bean // A Spring Security filter chain for the Protocol Endpoints.
    @Order(1)
